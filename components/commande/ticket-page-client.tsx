// components/commande/ticket-page-client.tsx
"use client";
...
export default function TicketPageClient({ order }: TicketPageClientProps) {
  const { clearCart } = useCartStore();

  useEffect(() => {
    // Vider le panier une fois que le ticket est affiché
    clearCart();
  }, [clearCart]);
