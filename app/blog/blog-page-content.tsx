                ...
                <Link key={article.id} href={`/blog/${article.id}`} className="group">
                  <article>
                    ...
                    <div>
                      ...
                      <p className="font-sans text-sm text-black/70 mb-4 line-clamp-2">{article.excerpt}</p>
                      <Button
                        variant="outline"
                        className="rounded-none border-black hover:bg-black hover:text-white font-sans text-xs uppercase tracking-widest bg-transparent"
                      >
                        Lire l'article
                      </Button>
                    </div>
