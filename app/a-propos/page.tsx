...
export default function AboutPage() {
  return (
    <div className="min-h-screen pt-24 lg:pt-32 flex flex-col items-center justify-center">
      ...
      <div className="max-w-4xl mx-auto text-xl text-gray-700 leading-relaxed text-center">
        <p className="mb-6">
